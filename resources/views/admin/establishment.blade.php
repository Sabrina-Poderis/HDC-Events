...
@section('content')
    ...
    <div>
        <button class="btn btn-success text-light" data-bs-toggle="modal" data-bs-target="#modalEstablishment">
        ...
        <div class="card-body">
            <div class="table-responsive mt-3">
                <table class="table table-striped table-borderless table-hover">
                    <caption>Total: 0 estabelecimentos</caption>
                    <thead class=>
                        <th>#</th>
                        <th>First</th>
                        <th>Last</th>
    ...
    <div class="modal fade" id="modalEstablishment" tabindex="-1" aria-labelledby="modalEstablishmentLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEstablishmentLabel">Estabelecimento</h5>
